...
---Q2. Write a SQL query to retreive all transactions where the category is clothing and quatity sold is more that 4 in the month of Nov-2022?
...
Select category, sum(total_sale) as TotalSalesByCategory, count(quantiy) as Total_orders
from dbo.[SQL - Retail Sales Analysis_utf ]
group by category
...
---Q10. Write a SQL query to create each shift and number of orders in each shift?
WITh Hourly_Sale AS(
SELECT 
    CASE
